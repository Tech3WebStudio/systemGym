...
const Members = () => {
  ...
  const handleDeleteMember = (id) => {
    const swalWithBootstrapButtons = Swal.mixin({
      customClass: {
        confirmButton: "p-2 rounded-lg ml-1 text-white bg-red-500",
        cancelButton: "p-2 rounded-lg ml-1 text-white bg-gray-400",
      },
            ...
            currentMembers.map((member, i) => (
              <tr key={i}>
                ...
                <td className="flex gap-2">
                  ...
                  <button className="p-2 rounded-full border border-blue-500 text-blue-500 hover:border-blue-600 hover:text-blue-600">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                      viewBox="0 0 24 24"
