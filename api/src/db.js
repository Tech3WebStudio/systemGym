...
User.belongsToMany(SpecialGroup, { through: UserSpecialGroups, foreignKey: 'userId' });
SpecialGroup.belongsToMany(User, { through: UserSpecialGroups, foreignKey: 'specialGroupId' });
